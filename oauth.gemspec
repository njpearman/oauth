...
Gem::Specification.new do |s|
  ...
  s.authors = ["Pelle Braendgaard", "Blaine Cook", "Larry Halff", "Jesse Clark", "Jon Crosby", "Seth Fitzsimmons", "Matt Sanford", "NJ Pearman"]
  s.date = %q{2009-09-29}
  s.default_executable = %q{oauth}
  s.description = %q{Forked OAuth Ruby implementation}
  s.email = %q{n.pearman@gmail.com}
  s.executables = ["oauth"]
  ...
  s.summary = %q{Forked OAuth Ruby implementation}
